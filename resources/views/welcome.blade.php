    ...
    @section('content')
        ...
        <div class="item3">
            ...
            <div class="d-flex justify-content-around">
                <div class="m-0 row justify-content-center h-auto d-inline-block" style="width: 400px">
                ...
                <div class="m-0 row justify-content-center h-auto d-inline-block" style="width: 400px">
                    <h2 class="text-center">Vision</h2><br />
            ...
            <div >
                <h2 class="text-center">¿Qué Buscamos?</h2>
                <div class="row" style="width: 100%; display: flex; align-items: center; justify-content: center;">
                    <div class="col-4" style="width: 20%">
                        <div class="list-group" id="list-tab" role="tablist">
                            <a class="list-group-item list-group-item-action" id="list-walfare-list" data-toggle="list" href="#list-walfare" role="tab" aria-controls="walfare">Bienestar animal</a>
                            <a class="list-group-item list-group-item-action" id="list-adoption-list" data-toggle="list" href="#list-adoption" role="tab" aria-controls="adoption">Adopción exitosa</a>
                            <a class="list-group-item list-group-item-action" id="list-education-list" data-toggle="list" href="#list-education" role="tab" aria-controls="education">Educación y concientización</a>
                            <a class="list-group-item list-group-item-action" id="list-collaboration-list" data-toggle="list" href="#list-collaboration" role="tab" aria-controls="collaboration">Colaboración y alianzas estrategicas</a>
                            <a class="list-group-item list-group-item-action" id="list-inspiration-list" data-toggle="list" href="#list-inspiration" role="tab" aria-controls="inspiration">Inspirar a la comunidad</a>
                        </div>
                    </div>
                    <div class="col-8" style="width: 40%; justify-content:">
                        <div class="tab-content" id="nav-tabContent" style="text-align:justify; text-justify:inter-word">
                            <div class="tab-pane fade show" id="list-walfare" role="tabpanel" aria-labelledby="list-walfare-list">Brindamos un sitio para que las instituciones o personas logren encontrar un sitio donde se asegure el bienestar físico, emocional y social de todas las mascotas bajo el cuidado los hogares. Nuestro objetivo es ser un sitio donde personas que buscan adoptar una mascota tengan la oportunidad de brindar una vida plena, libre de sufrimiento y enriquecida con amor y atención constante.</div>
