    ...
    >
        ...
        <div>
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right"> 
                ...
                @else
                    <a style="padding-right: 10px; font-size: 30px" href="{{ route('login') }}" >Iniciar sesion</a>

                    @if (Route::has('register'))
                        <a style="padding-right: 10px; font-size: 30px"     href="{{ route('register') }}" >Quiero ser parte de esta familia</a>
                    @endif
                @endauth
            </div>
        @endif
