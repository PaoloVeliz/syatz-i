  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Recuerda que las noticias deben de ser reales, no queremos mal informar personas
        <hr>
        Tambien recuerda mantener la educacion en el post, todo aquello que no cumpla con las normas de educacion será eliminado
      </div>
...
<div class="mb-3">
  ...
  <input class="form-control" type="file" id="formFile">
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-dismiss="modal" data-bs-toggle="modal"  >Terminar</button>
      </div>
    </div>
  </div>
</div>
<a class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle" role="button" style="margin-bottom: 20px;">Que deseas publicar hoy</a>
</template>